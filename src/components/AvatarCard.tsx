  ...
  return (
    <div
      ...
      className="group relative cursor-pointer rounded-full aspect-square overflow-hidden bg-zinc-950 
                 ...
                 // --- New, multi-layered red glow effect ---
    ...
    >
      {/* --- Added: Inner shadow for a 3D "bubble" effect --- */}
      ...
      {/* --- Refined Text Info & Gradient Overlay --- */}
      <div className="absolute inset-0 z-20 flex items-end justify-center bg-gradient-to-t from-black/80 via-black/30 to-transparent p-6 text-center">
        <div>
          ...
          <p className="text-sm text-zinc-200 drop-shadow-[0_1px_2px_rgba(0,0,0,0.9)] line-clamp-2">
            {avatar.description}
          </p>
        </div>
      </div>

      {/* --- Added: Top highlight for a "glass" effect --- */}
